...
public class Router<EndPoint: NetworkEndpoint>: NetworkRouter {
    ...
    public func request(route: EndPoint, completion: @escaping NetworkRouterCompletion) {
    ...
    public func request(route: EndPoint, timeout: TimeInterval, completion: @escaping NetworkRouterCompletion) {
